...
NBA_DEFENSIVE_SCHEMES: dict[str, TeamDefenseProfile] = {
    ...
    "San Antonio Spurs": TeamDefenseProfile(
        ...
        vs_pick_roll="drop",
        zone_frequency=0.15,
        blitz_frequency=0.18,           # they LOVE to double Wemby opponents
        vs_superstar="double",
        perimeter_defense="average",
        paint_defense="good",           # Wembanyama
        transition_defense="average",
        pts_allowed_mult=1.02,
        three_allowed_mult=1.04,
        paint_pts_mult=0.82,            # Wemby blocks everything in paint
        ast_allowed_mult=1.10,          # doubles create open looks
    ),
